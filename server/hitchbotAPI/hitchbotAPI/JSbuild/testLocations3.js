var flightPlanCoordinates = [ 
 ...
 new google.maps.LatLng(49.2829731,-123.0483733), ]; 
                ...
                var marker = new google.maps.Marker({
                    position: new google.maps.LatLng(44.6494,-63.574),
            map: map,
            animation: google.maps.Animation.DROP,
            icon: pinImage,
            shadow: pinShadow}); return marker;}function AddEndMarker1(map){
                ...
                var marker = new google.maps.Marker({
                    position: new google.maps.LatLng(49.2829731,-123.0483733),
            map: map,
            animation: google.maps.Animation.DROP,
            icon: pinImage,
            shadow: pinShadow}); return marker;}function initialize() {
                        var mapOptions = {
                          center: { lat: 46.96618655, lng: -93.31118665},
                          zoom: 4
                        };
                        ...
                        //generated by the server every set period of time!
                        	AddPolyFill0(map);	AddStartMarker0(map);	AddEndMarker1(map);
                      }
