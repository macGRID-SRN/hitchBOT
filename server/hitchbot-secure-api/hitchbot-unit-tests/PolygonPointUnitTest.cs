...
namespace hitchbot_unit_tests
{
	...
	public class PolygonPointTest
	{
		...
		[TestMethod]
		public void TestPolygonIntersectionWestUSA()
		{
			//coordinates of the polygon
			var coords = new List<Location>
			{
				new Location
				{
					Latitude = 69.83962194067463,
					Longitude = -142.119140625
				},
				new Location
				{
					Latitude = 59.17592824927136,
					Longitude = -140.2734375
				},
				new Location
				{
					Latitude = 44.08758502824516,
					Longitude = -124.365234375
				},
				new Location
				{
				...
				new Location
				{
					Latitude = 48.69096039092549,
					Longitude = -160.83984375
				},
				new Location
				{
					Latitude = 70.61261423801925,
					Longitude = -158.90625
				}
			};
			...
			var point = new List<Location>
			{
				new Location
				{
					Latitude =  48.031407913317,
					Longitude = -139.42895345
				},
				new Location
				{
					Latitude = 31.55648711141025,
					Longitude = -119.03832845
				},
				new Location
				{
					Latitude = 29.861078831263907,
					Longitude = -117.1761458328125
				},
				new Location
				{
					Latitude = 48.7524825467513,
					Longitude = -160.75684956816406
				}
			};
			...
			var outsidePoints = new List<Location>
			{
				new Location()
				{
					Latitude = 48.73799359500272,
					Longitude = -160.96558980253906
				},
				new Location()
				{
					Latitude = 61.13521891928217,
					Longitude = -161.31715230253906
				},
				new Location()
				{
					Latitude = 58.71397525522975,
					Longitude = -139.16871480253906
				},
				new Location()
				{
					Latitude = 33.123643319576104,
					Longitude = -116.84449605253906
				}
			};
		...
		[TestMethod]
		public void TestPolygonIntersectionCalifornia()
		{
			//coordinates of the polygon
			var coords = new List<Location>
			{
				new Location
				{
					...
					Longitude = -120.3167724609375
				},
				new Location
				{
					Latitude = 36.69044623523481,
					Longitude = -117.97119140625
				},
				new Location
				{
					Latitude = 35.23664622093195,
					Longitude = 118.564453125
				},
				new Location
				{
					Latitude = 35.69299463209881,
					Longitude = -119.7894287109375
				}
			};
			...
			var point = new List<Location>
			{
				new Location
				{
					Latitude =  36.152464868065266,
					Longitude = -119.23608235625
				},
				new Location
				{
					Latitude = 35.246916178621795,
					Longitude = -118.5714095046875
				},
				new Location
				{
					Latitude = 35.69874562343176,
					Longitude = -119.78814534453124
				},
				new Location
				{
					Latitude = 36.68070710963741,
					Longitude = -117.98638753203124
				}
			};
			...
			var outsidePoints = new List<Location>
			{
				new Location()
				{
					Latitude = 36.7005288113763,
					Longitude = -117.95342854765624
				},
				new Location()
				{
					Latitude = 36.621211354228926,
					Longitude = -120.53521565703124
				},
				new Location()
				{
					Latitude = 35.08076007746125,
					Longitude = -119.32122639921874
				},
				new Location()
				{
					Latitude = 35.98818140249786,
					Longitude = -118.19512776640624
				}
			};
		...
		[TestMethod]
		public void TestPolygonIntersection13()
		{
			//coordinates of the polygon
			var coords = new List<Location>
			{
				new Location
				{
					Latitude = 54.265224078605655,
					Longitude = 149.23828125
				},
				new Location
				{
					Latitude = 36.31512514748051,
					Longitude = 135.703125
				},
				new Location
				{
					Latitude = 7.013667927566642,
					Longitude = 159.9609375
				},
				new Location
				{
					Latitude = 33.13755119234614,
					Longitude = -130.78125
				},
				new Location
				{
					Latitude = 56.75272287205736,
					Longitude = -144.84375
				},
				new Location
				{
					Latitude = 61.270232790000605,
					Longitude = 177.890625
				}
			};
			...
			var point = new List<Location>
			{
				new Location
				{
					Latitude =  33.14348068293597,
					Longitude = -130.79369954375
				},
				new Location
				{
					Latitude = 7.031600116643776,
					Longitude = 159.9759577765625
				},
				new Location
				{
					Latitude = 36.329682262084084,
					Longitude = 135.72913960468765
				},
				new Location
				{
					Latitude = 54.25652616494699,
					Longitude = 149.26430385468768
				}
			};
			...
			var outsidePoints = new List<Location>
			{
				new Location()
				{
					Latitude = 54.27577489943299,
					Longitude = 149.20937221406268
				},
				new Location()
				{
					Latitude = 61.27891637243943,
					Longitude = 178.01553055781267
				},
				new Location()
				{
					Latitude = 58.51461239184293,
					Longitude = -158.07821744218734
				},
				new Location()
				{
					Latitude = 35.15265301907051,
					Longitude = 136.73990179218765
				}
			};
